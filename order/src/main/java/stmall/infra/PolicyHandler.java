...
public class PolicyHandler {
    ...
    @StreamListener(
        ...
        condition = "headers['type']=='StockInceased'"
    )
    public void wheneverStockInceased_SendAlert(
        @Payload StockInceased stockInceased
    ) {
        StockInceased event = stockInceased;
        System.out.println(
            "\n\n##### listener SendAlert : " + stockInceased + "\n\n"
        );
